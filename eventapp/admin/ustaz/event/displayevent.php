...
if($eventpage == "" || $eventpage =="1")
{
	$eventpage1 = 0;
}
else
{
	$eventpage1 = ($eventpage * 7)-7;
}
...
<html lang="en">
  ...
  <body>
	...
	$sqltotal = "SELECT count(*) FROM event WHERE uid = '$uid' AND estatus = 0";
            ...
            <div class="col-md-9">
            	<div class="panel panel-default">
                  <div class="panel-heading main-color-bg"> 
                    <h3 class="panel-title"><b>Ustaz Event : <?php echo $num4; ?></b></h3>
                     <h3 class="panel-title" align="right" ><b>Page : <?php 
					  ...
					  for($b = 1; $b <= $a; $b++)
						{
							?><a href="displayevent.php?eventpage=<?php echo $b; ?>" class="panel-title"><?php echo $b."  "; ?></a> <?php
						}
                  ...
                  $sql = "SELECT * FROM event WHERE uid = '$uid' AND estatus = 0 ORDER BY edate ASC LIMIT $eventpage1, 7";
                  ...
                  <td><div align="center"><a href="detailsevent.php?uid=<?php echo $data ['uid'];?>&eid=<?php echo $data ['eid'];?>"><img src="../../images/calendar.png" width="30" height="30" /></a></div></td>
                  <td><div align="center"><a onClick="return confirm('Are you sure you want delete the lecture session?')" href="deleteevent.php?uid=<?php echo $data ['uid']?>&eid=<?php echo $data ['eid'];?>"><img src="../../images/trash.png" width="30px" height="30px" /></a></div></td>
                </tr>
                 <?php } ?>
              </table>
                </div>    
