...
public class SearchProductAdapter extends BaseAdapter {
    ...
    public SearchProductAdapter(Context c, ArrayList<HashMap<String, String>> data) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.lvustaz.setText(productlist.get(position).get(UserConfig.TAG_UPROFILENAME));
