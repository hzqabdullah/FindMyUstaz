            ...
            <div class="col-md-9">
            	<div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span>   <?php echo $num1; ?></h2>
                    <h5>Ustaz</h5>
                    </div>
                    </div>
                    <div class="col-md-3">
                    <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span>   <?php echo $num2; ?></h2>
                    <h5>Users</h5>
                    </div>
                    </div>
                    <div class="col-md-3">
                    <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span>   <?php echo $num3; ?></h2>
                    <h5>Waiting Ustaz</h5>
                    </div>
                    </div>
                     <div class="col-md-3">
                    <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>   <?php echo $num4; ?></h2>
