...
$waitingustazpage = $_GET['waitingustazpage'];

if($waitingustazpage == "" || $waitingustazpage =="1")
{
	$waitingustazpage1 = 0;
}
else
{
	$waitingustazpage1 = ($waitingustazpage * 5)-5;
}
            ...
            <div class="col-md-9">
            	<div class="panel panel-default">
                  <div class="panel-heading main-color-bg">
                    <h3 class="panel-title">Display Waiting Ustaz</h3>
                    <h3 class="panel-title" align="right" ><b>Page : <?php 
					  ...
					  for($b = 1; $b <= $a; $b++)
						{
							?><a href="displaywaitingustaz.php?waitingustazpage=<?php echo $b; ?>" class="panel-title"><?php echo $b."  "; ?></a> <?php
						}
                  ...
                  <tr>
                   ...
                   <?php 
					  ...
					  $sql = "SELECT * FROM tmpustaz WHERE ustatus = 0 ORDER BY uprofilename LIMIT $waitingustazpage1, 5";
                  ...
                  <b>
                    ...
                    <p><a href="detailswaitingustaz.php?uid=<?php echo $data ['uid'];?>"><img src="../images/detail1.png" width="35px" height="35px" /></a></p>
                    </b>
               	  </td>
                  </tr>
                 <?php } ?>
