...
$query = "SELECT * FROM tmpustaz WHERE uid = '$uid'";
...
<html lang="en">
  ...
  <section id="main">
      <div class="container">
          <div class="row">
            ...
            <div class="list-group">
              ...
              <a href="displaywaitingustaz.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>   Waiting Ustaz<span class="badge">  <?php echo $num3; ?></a>
    ...
    <table border="0" >
        <tr>
          <td width="200" rowspan="11" align="center"><p>&nbsp;</p></td>
          <td height="200" colspan="3" align="center"><?php echo '<img src="'.$data["uphoto"].'" width="150px" height="170px"/>'; ?></td>
          <td rowspan="2">&nbsp;</td>
          <td rowspan="2">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="110" rowspan="7" align="center"><p><a href="approvewaitingustaz.php?uid=<?php echo $data ['uid'];?>"><img src="../images/approved.png" alt="" width="60px" height="60px" /></a></p>
            <p>Approve</p>            <p>&nbsp;</p></td>
          <td width="110" rowspan="7" align="center"><p><a onClick="return confirm('Are you sure you want delete waiting Ustaz?')" href="deletewaitingustaz.php?uid=<?php echo $data ['uid'];?>"><img src="../images/deny.png" alt="" width="60px" height="60px" /></a></p>
            <p>Deny</p>            <p>&nbsp;</p></td>
          </tr>
        <tr>
