...
$transactionpage = $_GET['transactionpage'];

if($transactionpage == "" || $transactionpage =="1")
{
	$transactionpage1 = 0;
}
else
{
	$transactionpage1 = ($transactionpage * 7)-7;
}
...
<html lang="en">
  ...
  <body>
	...
	$sql5 = "SELECT count(*) FROM transaction";
            ...
            <div class="col-md-9">
            	<div class="panel panel-default">
                  <div class="panel-heading main-color-bg">
                    <h3 class="panel-title">Transaction History</h3>
                     <h3 class="panel-title" align="right" ><b>Page : <?php 
					  ...
					  for($b = 1; $b <= $a; $b++)
						{
							?><a href="displaytransaction.php?transactionpage=<?php echo $b; ?>" class="panel-title"><?php echo $b."  "; ?></a> <?php
						}
                  ...
                  <tr>
                  	...
                  	<th width="148">Address</th>
                    <th width="136">Paid On</th>
                    <th width="137">Shipped On</th>
                    <th width="138">Product</th>
                    <th width="96">Price</th>
                    <th width="71">Details</th>
                  </tr>
                  
                   <?php 
  
					  $sql = "SELECT * FROM transaction ORDER BY paydate DESC LIMIT $transactionpage1, 7";
                  ...
                  <td><a href="detailstransaction.php?transid=<?php echo $data ['transid'];?>"><img src="../images/calculator.png" width="35px" height="35px" /></a></td>            
                </tr>
                 <?php } ?>
              </table>
                </div>    
